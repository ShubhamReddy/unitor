...
public class rbtree{
    ...
    public void printTree(Node node) {
        ...
        printTree(node.left);
        System.out.print("P"+node.process.pId+" "+node.process.uf+((node.color==RED)?"R":"B ")+"  ");
    ...
    private Node findNode(Node findNode, Node node) {
        ...
        if (findNode.process.uf < node.process.uf) {
            if (node.left != nil) {
                return findNode(findNode, node.left);
            }
        } else if (findNode.process.uf  > node.process.uf ) {
            if (node.right != nil) {
    ...
    public void insert(process key) {
        ...
        if (root == nil) {
            ...
            node.color = RED;
            while (true) {
                if (node.process.uf < temp.process.uf ) {
                    if (temp.left == nil) {
                        temp.left = node;
                        node.parent = temp;
                        break;
               ...
               } else if (node.process.uf  >= temp.process.uf ) {
                    if (temp.right == nil) {
                        temp.right = node;
                        node.parent = temp;
                        break;
